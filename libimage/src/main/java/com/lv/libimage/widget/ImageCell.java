package com.lv.libimage.widget;
...
import com.lv.libimage.R;
import com.lv.libimage.util.Utils;
...
public class ImageCell extends ImageView {
    ...
    private class DrawableTarget extends DrawableImageViewTarget {
        ...
        public void onLoadStarted(Drawable placeholder) {
            setBackground();
            getView().setScaleType(ScaleType.FIT_CENTER);
        ...
        public void onResourceReady(@NonNull Drawable resource, @Nullable Transition<? super Drawable> transition) {
            ...
            getView().setScaleType(ScaleType.CENTER_CROP);
