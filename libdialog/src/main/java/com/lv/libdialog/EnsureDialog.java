...
public class EnsureDialog {
    ...
    public EnsureDialog builder() {
        ...
        mLinearDialog = view.findViewById(R.id.linear_dialog);
     ...
     * @return
     */
    public EnsureDialog setBackgroundResource(int resource) {
        mLinearDialog.setBackgroundResource(resource);
        return this;
    }
     ...
     * @return
     */
    public EnsureDialog setBackgroundColor(int color) {
        mLinearDialog.setBackgroundColor(color);
        return this;
    }
