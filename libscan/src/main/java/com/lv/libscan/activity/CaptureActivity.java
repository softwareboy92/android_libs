package com.lv.libscan.activity;
...
import com.lv.libscan.R;
import com.lv.libscan.camera.CameraManager;
import com.lv.libscan.decode.MainHandler;
import com.lv.libscan.utils.BeepManager;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private void initView() {
        ...
        TextView _textTitle = findViewById(R.id.scan_title);
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setPositiveButton(getString(R.string.i_know), (DialogInterface dialog, int which) -> {
