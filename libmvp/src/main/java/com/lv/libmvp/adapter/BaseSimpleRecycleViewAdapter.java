...
import com.lv.libmvp.listener.OnItemClickListener;
import com.lv.libmvp.listener.OnItemLongClickListener;
 ...
 */
public abstract class BaseSimpleRecycleViewAdapter<M> extends RecyclerView.Adapter<BaseViewHolder> {
