package com.lv.libmvp.languageutils;
...
import com.lv.libmvp.utils.CommSharedUtil;
...
public class MultiLanguageUtil {
    ...
    private Locale getLanguageLocale() {
        ...
        }else if (languageType == LanguageType.LANGUAGE_CHINESE_JAPANESE){
            //日语
            return Locale.JAPANESE;
        }else if (languageType == LanguageType.LANGUAGE_CHINESE_KOREAN){
            //韩语
    ...
    public String getLanguageName(Context context) {
        ...
        if (languageType == LanguageType.LANGUAGE_EN) {
            ...
            return mContext.getString(R.string.setting_language_Japanese);
        }else if (languageType==LanguageType.LANGUAGE_CHINESE_KOREAN){
            return mContext.getString(R.string.setting_language_Korean);
        }
        ...
        int languageType = CommSharedUtil.getInstance(mContext).getInt(MultiLanguageUtil.SAVE_LANGUAGE, LanguageType.LANGUAGE_FOLLOW_SYSTEM);
         if (languageType == LanguageType.LANGUAGE_CHINESE_SIMPLIFIED) {
           ...
           return LanguageType.LANGUAGE_FOLLOW_SYSTEM;
             ...
             return LanguageType.LANGUAGE_CHINESE_JAPANESE;
         }else if (languageType == LanguageType.LANGUAGE_CHINESE_KOREAN){
             return LanguageType.LANGUAGE_CHINESE_KOREAN;
         }
